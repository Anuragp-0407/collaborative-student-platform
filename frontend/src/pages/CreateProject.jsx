...
const CreateProject = () => {
  ...
  const removeTechnology = (technologyToRemove) => {
    setTechnologies((previous) =>
      previous.filter((technology) => technology !== technologyToRemove),
    );
  };
    ...
    <DashboardLayout>
      <div className="mx-auto max-w-5xl">
            ...
            <div className="relative flex items-start gap-4">
              ...
              <div>
                ...
                <p className="mt-2 max-w-2xl text-sm leading-6 text-white/35">
                  Turn your idea into a collaborative project and find students
        ...
        <form onSubmit={handleSubmit} className="mt-6 space-y-6">
            ...
            <div className="grid gap-5">
              ...
              <div>
                ...
                <select
                  ...
                  onChange={handleChange}
                  className={`w-full cursor-pointer rounded-xl border bg-black/20 px-4 py-3 text-sm text-white outline-none transition-all duration-300 ${
                    errors.category
                      ? "border-red-400/40 bg-red-500/[0.03] focus:border-red-400/60 focus:ring-2 focus:ring-red-500/10"
                      : "border-white/[0.08] focus:border-violet-400/30 focus:bg-violet-500/[0.03] focus:ring-2 focus:ring-violet-500/10"
                  }`}
                >
                  <option value="" className="bg-[#17151f]">
                    Select a category
                  </option>

                  <option value="Web Development" className="bg-[#17151f]">
                    Web Development
                  </option>

                  <option value="Mobile Development" className="bg-[#17151f]">
                    Mobile Development
                  </option>

                  <option value="AI / ML" className="bg-[#17151f]">
                    AI / ML
                  </option>

                  <option value="Data Science" className="bg-[#17151f]">
                    Data Science
                  </option>

                  <option value="Cyber Security" className="bg-[#17151f]">
                    Cyber Security
                  </option>

                  <option value="Other" className="bg-[#17151f]">
                    Other
                  </option>
                </select>
          ...
          {errors.category && (
            <p className="mt-2 text-[11px] text-red-300">⚠ {errors.category}</p>
          )}
          ...
          <section className="animate-fade-up rounded-2xl border border-white/[0.07] bg-white/[0.025] p-5 sm:p-7">
            <div className="mb-6 flex items-center gap-3">
              <div className="flex h-9 w-9 items-center justify-center rounded-lg border border-fuchsia-400/15 bg-fuchsia-500/[0.07]">
                <Code2 size={17} className="text-fuchsia-300" />
              </div>

              <div>
                <h2 className="text-base font-bold">Project Requirements</h2>

                <p className="mt-0.5 text-[11px] text-white/25">
                  Tell collaborators what your project needs.
                </p>
              </div>
            </div>
              ...
              <div className="max-w-sm">
                ...
                {errors.maxTeamSize ? (
                  ...
                  <p className="mt-2 text-[10px] text-white/20">
                    Include yourself when deciding the maximum team size.
          ...
          <section className="animate-fade-up rounded-2xl border border-white/[0.07] bg-white/[0.025] p-5 sm:p-7">
            <div className="mb-6 flex items-center gap-3">
              <div className="flex h-9 w-9 items-center justify-center rounded-lg border border-cyan-400/15 bg-cyan-500/[0.07]">
                <ExternalLink size={17} className="text-cyan-300" />
              </div>
              ...
              <div>
                ...
                <p className="mt-0.5 text-[11px] text-white/25">
                  Optional links to help collaborators explore your work.
                </p>
              </div>
            </div>
